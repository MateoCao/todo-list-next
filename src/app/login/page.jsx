  ...
  return (
    <div id='registerBody' className='flex flex-wrap w-full h-screen'>
      <div id='register' className='bg-white rounded shadow-xl flex flex-col gap-8 w-3/5 px-60 py-14'>
          <h3 className='text-2xl font-semibold'>Inicio de sesion</h3>
          <form className="flex flex-col gap-2" onSubmit={handleSubmit(userRegister)}>
              ...
              <input className='bg-sky-500 hover:bg-sky-600 rounded text-white font-semibold text-lg p-2 mt-2 cursor-pointer duration-200' type='submit' value="Iniciar sesion" />
          </form>
         {/* <button className='bg-white text-black w-10 h-10' onClick={handleSignOut}>Desloguate!!!</button>  */}
         <div className='flex w-full justify-center'>
              <p><Link href="/register" className='text-sky-700'>¿Olvidaste tu contraseña?</Link></p>
              {/*<Link href="/" className='text-sky-700'>Volver al inicio</Link>*/}
          </div>
          <div className='w-full flex flex-wrap justify-center items-center gap-5'>
            <div className='w-1/3'> <hr /> </div>
            <p className=' text-xs text-gray-400 font-semibold'>o iniciar con</p>
            <div className='w-1/3'> <hr /> </div>
          </div>
          ...
          <div className='flex w-full justify-center'>
              <p>¿No estas registrado? <Link href="/register" className='text-sky-700'>¡Registrate!</Link></p>
              {/*<Link href="/" className='text-sky-700'>Volver al inicio</Link>*/}
          </div>
      </div>
